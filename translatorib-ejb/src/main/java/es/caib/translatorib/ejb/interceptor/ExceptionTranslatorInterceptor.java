...
import es.caib.translatorib.service.exception.RecursNoTrobatException;
import es.caib.translatorib.service.exception.ServiceException;
import es.caib.translatorib.service.exception.TranslationServiceException;
...
public class ExceptionTranslatorInterceptor implements Serializable {
    ...
    private ServiceException processPersistenceException(PersistenceException exception) {
        ...
        return new TranslationServiceException(exception);
    }
}
