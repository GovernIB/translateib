...
import es.caib.translatorib.persistence.EstatPublicacio;
import es.caib.translatorib.persistence.UnitatOrganica;
...
public class UnitatOrganicaServiceTest {
    ...
    private static final String BASE_URL = "http://localhost:8080/translatorib/api/services";
