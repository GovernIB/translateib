...
INSERT INTO TIB_CNFGLO(CFG_CODIGO, CFG_PROP,CFG_VALOR,CFG_DESCR,CFG_NOMOD) VALUES (TIB_CNFGLO_SEQ.NEXTVAL, 'frontal.restapi.url', 'http://www.caib.es/translatorib/api/services/traduccion/v1/texto','Cuando se conecta desde el frontal, la url de texto.',1);
INSERT INTO TIB_CNFGLO(CFG_CODIGO, CFG_PROP,CFG_VALOR,CFG_DESCR,CFG_NOMOD) VALUES (TIB_CNFGLO_SEQ.NEXTVAL, 'frontal.restapi.url.doc', 'http://www.caib.es/translatorib/api/services/traduccion/v1/documento','Cuando se conecta desde el frontal, la url de doc.',1);
INSERT INTO TIB_CNFGLO(CFG_CODIGO, CFG_PROP,CFG_VALOR,CFG_DESCR,CFG_NOMOD) VALUES (TIB_CNFGLO_SEQ.NEXTVAL, 'frontal.restapi.usr', 'api-tib','Cuando se conecta desde el frontal, el usuario.',1);
INSERT INTO TIB_CNFGLO(CFG_CODIGO, CFG_PROP,CFG_VALOR,CFG_DESCR,CFG_NOMOD) VALUES (TIB_CNFGLO_SEQ.NEXTVAL, 'frontal.restapi.pwd', 'XXXX','Cuando se conecta desde el frontal, el pwd.',1);
