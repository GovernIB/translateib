 ...
 * Si no s'indica el <code>locale</code> per la trauducció agafarà {@link Locale#getDefault()}.
 * <p>
 * Les intàncies s'obtenen cridant {@link #from(String...)}, passant per paràmetre noms de recursos que es carregaran
