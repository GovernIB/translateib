...
import static es.caib.translatorib.api.interna.config.ApiConstants.REQUEST_LOCALE;
import static es.caib.translatorib.api.interna.config.ApiConstants.SUPPORTED_LOCALES;
