package es.caib.translatorib.core.interceptor;
...
import es.caib.translatorib.core.api.exception.DatabaseException;
import es.caib.translatorib.core.api.exception.ErrorNoControladoException;
import es.caib.translatorib.core.api.exception.ServiceException;
import es.caib.translatorib.core.api.exception.ServiceRollbackException;
...
public final class NegocioInterceptorAspect {
	 ...
	 *            JointPoint
	 */
	@Before("@annotation(es.caib.translatorib.core.interceptor.NegocioInterceptor)")
	 ...
	 *            Objeto retornado
	 */
	@AfterReturning(pointcut = "@annotation(es.caib.translatorib.core.interceptor.NegocioInterceptor)", returning = "retVal")
	 ...
	 *            Exception
	 */
	@AfterThrowing(pointcut = "@annotation(es.caib.translatorib.core.interceptor.NegocioInterceptor)", throwing = "ex")
