package es.caib.translatorib.persistence.model;
 ...
 */
@Entity
@SequenceGenerator(name = "configuracion-sequence-frontal", sequenceName = "TIB_CNFFRO_SEQ", allocationSize = 1)
...
public class JConfiguracionFrontal {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "configuracion-sequence-frontal")
