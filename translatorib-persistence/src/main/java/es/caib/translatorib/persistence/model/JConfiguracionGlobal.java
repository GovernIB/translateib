 ...
 */
@Entity
@SequenceGenerator(name = "configuracion-sequence-global", sequenceName = "TIB_CNFGLO_SEQ", allocationSize = 1)
...
public class JConfiguracionGlobal {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "configuracion-sequence-global")
