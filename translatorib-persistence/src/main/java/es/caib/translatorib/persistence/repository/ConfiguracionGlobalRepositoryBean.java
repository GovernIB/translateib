...
import es.caib.translatorib.persistence.model.JConfiguracionGlobal;
...
public class ConfiguracionGlobalRepositoryBean extends AbstractCrudRepository<JConfiguracionGlobal, Long> implements ConfiguracionGlobalRepository {


	public ConfiguracionGlobalRepositoryBean() {
	...
	public List<ConfiguracionGlobal> findPagedByFiltro(ConfiguracionGlobalFiltro filtro) {
		...
		List<ConfiguracionGlobal> configuracionGlobal = new ArrayList<ConfiguracionGlobal>();
